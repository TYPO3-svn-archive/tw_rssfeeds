	...
	class tx_twrssfeeds_pi1 extends tslib_pibase {
		...
		*/
		function main($content, $conf) {
			...
			$get_displaycharset = $this->pi_getFFvalue($this->cObj->data['pi_flexform'], 'displaycharset', 'sDEF');
			$get_displaychar = $get_displaycharset ? $get_displaycharset:
			$this->conf['displaycharset'];
			...
			switch($get_displaychar){ //only for output rendering
				...
				case 'ISO88593':
				$content = mb_convert_encoding($content,"iso-8859-3","UTF-8");
				break;
				
				case 'ISO88594':
				$content = mb_convert_encoding($content,"iso-8859-4","UTF-8");
				break;
				
				case 'ISO88595':
				$content = mb_convert_encoding($content,"iso-8859-5","UTF-8");
				break;
				
				case 'ISO88596':
				$content = mb_convert_encoding($content,"iso-8859-6","UTF-8");
				break;
				
				case 'ISO88597':
				$content = mb_convert_encoding($content,"iso-8859-7","UTF-8");
				break;
				
				case 'ISO88598':
				$content = mb_convert_encoding($content,"iso-8859-8","UTF-8");
				break;
